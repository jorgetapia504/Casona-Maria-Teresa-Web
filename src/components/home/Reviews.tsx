  ...
  return (
    <div ref={ref} className="w-full max-w-7xl m-auto px-2 py-20 text-center flex flex-col gap-6">
          ...
          <div className="flex gap-4 justify-between flex-wrap">
            <div className={`${image1} transition-opacity duration-200 m-auto flex flex-col gap-2 w-96 my-auto p-6 shadow-lg border border-neutral-100 rounded-lg`}>
            ...
            <div className={`${image2} transition-opacity duration-200 m-auto flex flex-col gap-2 w-96 my-auto p-6 shadow-lg border border-neutral-100 rounded-lg`}>
            ...
            <div className={`${image3} transition-opacity duration-200 m-auto flex flex-col gap-2 w-96 my-auto p-6 shadow-lg border border-neutral-100 rounded-lg`}>
