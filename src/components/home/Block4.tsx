...
const [text, setText] = useState('opacity-0')
  ...
  return (
    <div ref={ref} className="flex flex-col gap-6 w-full max-w-7xl m-auto px-2 py-20">
      ...
      <p className={`${text} transition-opacity duration-200 text-center text-lg lg:text-xl`}>Estamos ubicados cerca del metro Plaza de Maipú, al lado del templo Votivo de Maipú.</p>
