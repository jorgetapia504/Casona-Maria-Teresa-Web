...
const [title, setTitle] = useState('opacity-0')
  ...
  return (
    <div ref={ref} className="relative w-full text-white m-auto px-2 py-24 text-center flex flex-col gap-6 bg-cover bg-center" style={{ backgroundImage: 'url("/Foto 2.jpg")' }}>
          ...
          <p className={`${text} transition-opacity duration-200 text-md text-center lg:text-xl`}>Haz tu evento sin estres teniendo todo lo que necesitas en un solo lugar, bar libre toda la fiesta, comida variada con cocktail, bocadillos, entrada, plato de fondo y postres, musica a tu gusto, decoración ambientada a tu celebración y mucho más.</p>
